...
#define CLUSTER_PORT_INCR 1 /* Cluster port = baseport + PORT_INCR */
...
typedef struct clusterNode {
    ...
    char tag[CONFIG_TAG_STR_LEN];      /* Node tag */
...
typedef struct {
    ...
    char nodetag[CONFIG_TAG_STR_LEN]; /* node->tag copy */
...
typedef struct {
    ...
    char sendertag[CONFIG_TAG_STR_LEN];  /* Tag of the node */
